...
CAV.Array = typeof Float32Array === "function"
    ? Float32Array
    : Array;
CAV.Utils = {
    isNumber: function (a) {
...
CAV.Triangle = function (a, b, c) {
    ...
    this
        .polygon
        .setAttributeNS(null, "stroke-miterlimit", "1");
    this
        .polygon
        .setAttributeNS(null, "stroke-width", "1");
    this.computeCentroid();
    this.computeNormal()
};
CAV.Triangle.prototype = {
    computeCentroid: function () {
        this.centroid[0] = this
            .a
            .position[0] + this
            .b
            .position[0] + this
        ...
        CAV
            .Vector3
            .divideScalar(this.centroid, 3);
        return this
    },
    computeNormal: function () {
        CAV
            .Vector3
            .subtractVectors(this.u, this.b.position, this.a.position);
        CAV
            .Vector3
            .subtractVectors(this.v, this.c.position, this.a.position);
        CAV
            .Vector3
            .crossVectors(this.normal, this.u, this.v);
        CAV
            .Vector3
    ...
    if (b) 
        for (c = this.geometry.triangles.length - 1; c >= 0; c--) {
            ...
            for (e = a.length - 1; e >= 0; e--) 
                ...
                CAV
                    .Vector3
                    .subtractVectors(f.ray, f.position, d.centroid),
                CAV
                    .Vector3
                    .normalise(f.ray),
                g = CAV
                ...
                CAV
                    .Vector4
                    .multiplyScalar(this.material.slave.rgba, g),
                CAV
                    .Vector4
                    .add(d.color.rgba, this.material.slave.rgba);
            CAV
                .Vector4
                .clamp(d.color.rgba, 0, 1)
        }
    return this
};
CAV.Scene = function () {
...
CAV.Scene.prototype = {
    add: function (a) {
        a instanceof CAV.Mesh && !~this
            .meshes
            .indexOf(a)
                ? this
                    .meshes
                    .push(a)
                : a instanceof CAV.Light && !~this
                    .lights
                    .indexOf(a) && this
                    .lights
                    .push(a);
    ...
    remove: function (a) {
        a instanceof CAV.Mesh &&~ this
            ...
            .indexOf(a)
                ? this
                    .meshes
                    .splice(this.meshes.indexOf(a), 1)
                : a instanceof CAV.Light &&~ this
                    .lights
                    .indexOf(a) && this
                    .lights
                    .splice(this.lights.indexOf(a), 1);
        return this
    }
};
...
CAV.CanvasRenderer.prototype.setSize = function (a, b) {
    ...
    this
        .context
        .setTransform(1, 0, 0, -1, this.halfWidth, this.halfHeight);
    return this
};
CAV.CanvasRenderer.prototype.clear = function () {
    ...
    this
        .context
        .clearRect(-this.halfWidth, -this.halfHeight, this.width, this.height);
    return this
};
    ...
    for (b = a.meshes.length - 1; b >= 0; b--) 
        if (c = a.meshes[b], c.visible) {
            ...
            for (d = c.geometry.triangles.length - 1; d >= 0; d--) 
                ...
                this
                    .context
                    .moveTo(e.a.position[0], e.a.position[1]),
                this
                    .context
...
function Victor(container, anitOut) {
    if (!!document.createElement("canvas").getContext) {
        ...
        function K(O, N) {
            ...
            CAV
                .Vector3
                .set(L, D.halfWidth, D.halfHeight);
            s()
        }
        function o() {
            i = Date.now() - n;
        ...
        function u() {
            ...
            CAV
                .Vector3
                .multiplyScalar(G.bounds, G.xyScalar);
            CAV
                .Vector3
                .setZ(k, G.zOffset);
            for (R = I.lights.length - 1; R >= 0; R--) {
                ...
                CAV
                    .Vector3
                    .subtractVectors(T.force, k, T.position);
                CAV
                    .Vector3
                    .normalise(T.force);
                CAV
                    .Vector3
                    .multiplyScalar(T.force, W);
                CAV
                    .Vector3
                    .set(T.acceleration);
                CAV
                    .Vector3
                    .add(T.acceleration, T.force);
                CAV
                    .Vector3
                    .add(T.velocity, T.acceleration);
                CAV
                    .Vector3
                    .multiplyScalar(T.velocity, G.dampening);
                CAV
                    .Vector3
                    .limit(T.velocity, G.minLimit, G.maxLimit);
                CAV
                    .Vector3
                    .add(T.position, T.velocity)
            }
